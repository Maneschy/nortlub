...
<head>
    ...
    <title>NortLub Lubrificantes • Limpeza de Caixas</title>
...
<body>
    ...
    <section id="pageCover" class="row aboutUs">        <div class="row pageTitle">LIMPEZA DE CAIXAS</div>    </section>            <section id="blogs" class="row">            <div class="container">                <div class="row">                    <div class="col-sm-9">                        <div class="row">                            <div class="row blog sinlge-blog">                                <div class="row m0 blogInner">                                    <div class="row m0 featureImg">                                        <a href="single-post.html">                                            <img src="images/servicos/limpeza_caixas.jpg" alt="Faceted Search Has Landed" class="img-responsive">                                        </a>                                    </div>                                    <div class="row m0 postExcerpts">                                        <div class="row m0 postExcerptInner">                                            <a href="single-post.html" class="postTitle row m0"><h4>LIMPEZA DE CAIXAS</h4></a>                                            <p>Altamente especializada na limpeza de caixas d’água, a nossa equipe garante que o cliente esteja seguro quanto ao trabalho realizado. O moderno serviço de limpeza de caixa d´água é uma solução confiável para a remoção de impurezas, como areia, lama, algas, musgos, vírus e bactérias da caixa d´água – ideal para caixas d´água subterrâneas ou suspensas. A NortLub possui máquinas e equipamentos que eliminam todos os contaminantes da caixa d´água.</p>                                        </div>                                    </div>                                </div>                            </div>                                                                                                    </div>                    </div>                                       <?php include './menu_nortlub_servicos.php'; ?>                                     </div>                        </div>                    </section>                            </div>                    </div>  
