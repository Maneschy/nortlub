...
<head>
    ...
    <title>NortLub Lubrificantes • Limpeza de Caixas Separadoras</title>
...
<body>
    ...
    <section id="pageCover" class="row aboutUs">        <div class="row pageTitle">LIMPEZA DE CAIXAS SEPARADORAS</div>    </section>            <section id="blogs" class="row">            <div class="container">                <div class="row">                    <div class="col-sm-9">                        <div class="row">                            <div class="row blog sinlge-blog">                                <div class="row m0 blogInner">                                    <div class="row m0 featureImg">                                        <a href="single-post.html">                                            <img src="images/servicos/limpeza_caixas.jpg" alt="Faceted Search Has Landed" class="img-responsive">                                        </a>                                    </div>                                    <div class="row m0 postExcerpts">                                        <div class="row m0 postExcerptInner">                                            <a href="single-post.html" class="postTitle row m0"><h4>LIMPEZA DE CAIXAS SEPARADORAS</h4></a>                                            <p>A caixa separadora de óleo tem a função, como o próprio nome diz, de separar os óleos e graxas do restante do despejo. Os óleos e graxas tendem a flutuar e são acumulados na caixa coletora para serem esvaziados periodicamente. As caixas instaladas na garagem cumprem o papel de armazenar os resíduos provenientes de todos os processos e atividades internas.<br/><br/>                                                                                        A NORTLUB, executa limpezas em tanques dos mais variados portes e tamanhos, com equipamentos de última geração, estas limpezas podem inclusive ser manuais dependendo do caso.<br/><br/>                                                                                        Nossos técnicos são treinados para lidar com espaços confinados e atuarem nas mais diversas situações além de disponibilizarmos aos nossos clientes o gerenciamento dos resíduos gerados no processo de lavagem, ou seja, entregamos o seu tanque limpo, descontaminado e com os resíduos dispostos de forma ecologicamente correta.                                            </p>                                        </div>                                    </div>                                </div>                            </div>                                                                                                    </div>                    </div>                                       <?php include './menu_nortlub_servicos.php'; ?>                                     </div>                        </div>                    </section>                            </div>                    </div>  
