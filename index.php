...
<body>
                ...
                <ul>
                    ...
                    <li data-transition="boxslide" data-slotamount="7" >
                       ...
                       <div class="caption skewfromleft skewtoleft"  
                           ...
                           data-start="1900" 
                           data-easing="easeOutBack">
                           <p>This is Photoshop's version of Lorem Ipsum. Proin gravi-<br>da nibh vel velit auctor aliquet. Aenean solicitudin. lorem <br>quis bibendum auctor, nisi elit consequant.</p>
                       </div>
                       <div class="caption sfb stb"  
                           data-x="-100" 
                           data-y="375" 
    ...
    <section id="testimonials" class="row">
        <div class="container">
            <div class="row sectionTitles">
                <h2 class="sectionTitle whiteTC">TESTEMUNHAIS</h2>
                <div class="sectionSubTitle whiteTC">Quem conhece fala</div>
            </div>
            <div class="row">
                            ...
                            <div class="panel-heading" role="tab" id="headingOne">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#hAccordion" href="#collapse1" aria-expanded="true" aria-controls="collapse1">
                                        <i class="fa fa-question"></i>O que é o REREFINO? <span class="sign fa"></span>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab" id="heading2">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#hAccordion" href="#collapse2" aria-expanded="false" aria-controls="collapse2">
                                        <i class="fa fa-question"></i>Mesmo rendimento e produtividade? <span class="sign fa"></span>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab" id="heading3">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#hAccordion" href="#collapse3" aria-expanded="false" aria-controls="collapse3">
                                        <i class="fa fa-question"></i>O que é feito com os resíduos? <span class="sign fa"></span>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab" id="heading4">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#hAccordion" href="#collapse4" aria-expanded="false" aria-controls="collapse4">
                                        <i class="fa fa-question"></i>O lubrificante Rerefinado pode ser usado normalmente? <span class="sign fa"></span>
                                    </a>
                                </h4>
                            </div>
                            ...
                            <div class="panel-heading" role="tab" id="heading5">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#hAccordion" href="#collapse5" aria-expanded="false" aria-controls="collapse5">
                                        <i class="fa fa-question"></i>Tem mais dúvidas? <span class="sign fa"></span>
                                    </a>
                                </h4>
                            </div>
